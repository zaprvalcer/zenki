...
- Edit deployment descriptors path to path to web.xml. Mine is
    D:\Development\Zenki\src\main\webapp\web.xml
- Edit web resource directory path. Mine is
    D:\Development\Zenki\src\main\webapp\
    (relative path should stay "/")
